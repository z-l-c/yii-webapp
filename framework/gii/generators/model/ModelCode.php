	...
	public function prepare()
	{
		...
		foreach($tables as $table)
		{
			...
			$this->files[]=new CCodeFile(
				Yii::getPathOfAlias($this->modelPath).'/'.$className.'Data.php',
				$this->render($templatePath.'/model_data.php', $params)
			);
			$bizPath = Yii::getPathOfAlias($this->modelPath).'/'.$className.'.php';
			$this->files[]=new CCodeFile(
				$bizPath,
